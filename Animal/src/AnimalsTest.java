...
public class AnimalsTest {
	...
	public static void averageAge(List<Animal> lists) {
		...
		System.out.println("Average age of " + type + "is " + sum);
		System.out.println();
		System.out.println("------------------------------------------------- ");
	}
	...
	public static void main(String[] args) {
		...
		/*Declare dogs*/
		Animal pug = new Dog(50000, "Pug", Gender.MALE);
		...
		/*Declare cats*/
		Animal aegean = new Kitten(10000, "Kitty");
		Animal asianSemiLonghair = new Kitten(5000000, "Mice");
		...
		//Average Ages of each kinds of Animals
		averageAge(frogs);
		averageAge(dogs);
		averageAge(cats);
	}
