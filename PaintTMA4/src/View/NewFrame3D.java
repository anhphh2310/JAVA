...
public class NewFrame3D extends JFrame {
	/**
	 * 
	 */
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (pos == 0) {
					if (textFieldX.getText().equals("") || textFieldY.getText().equals("")
						...
						s = main.saf3d.createCircle(x, y, Integer.parseInt(textWidth.getText()));
						//s = ShapeFactory.getInstanceCircle(new ShapeFactory3d(x, y, Integer.parseInt(textWidth.getText()), -1));
						main.list3D.add(s);
						main.loadDataTable();
						main.reloadShape();
				...
				// Rectangle
					...
					//			Integer.parseInt(textFieldHeight.getText()), x, y);
						s = main.saf3d.createRectangle(x, y,Integer.parseInt(textWidth.getText()), Integer.parseInt(textFieldHeight.getText()));
						//s = ShapeFactory.getInstanceRectangle(new ShapeFactory3d(x, y, Integer.parseInt(textWidth.getText()), Integer.parseInt(textFieldHeight.getText())));
						main.list3D.add(s);
						main.loadDataTable();
						main.reloadShape();
						//main.listShape.add(s);
