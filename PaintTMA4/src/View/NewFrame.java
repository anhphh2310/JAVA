			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (pos == 0) {
					if (textFieldX.getText().equals("") || textFieldY.getText().equals("")
						...
						s = main.saf2d.createCircle(x, y, Integer.parseInt(textWidth.getText()));
				...
				// Rectangle
					...
					if (textFieldX.getText().equals("") || textFieldY.getText().equals("")
						...
						s = main.saf2d.createRectangle(x, y, Integer.parseInt(textWidth.getText()), Integer.parseInt(textFieldHeight.getText()));
