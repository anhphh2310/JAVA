...
public class Circle extends Shape implements Shape2d,Shape3d{
	...
	public void draw3d() {
		// TODO Auto-generated method stub
		System.out.println("Draw 3d Circle: Position(" + x + "," + y + "), raidus: " + radius);;
	}

	@Override
	public void draw2d() {
		// TODO Auto-generated method stub
		System.out.println("Draw 2d Circle: Position(" + x + "," + y + "), raidus: " + radius);
	}
}
