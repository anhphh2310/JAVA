...
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		...
		DrawFrame panel_draw = new DrawFrame(listShape);
	...
	public void draw3D(Shape shapeSelect) {
		if(shapeSelect==null) {
			JOptionPane.showMessageDialog(null, "Khong the ve", "", JOptionPane.ERROR_MESSAGE);
		}
		else {
			if(shapeSelect instanceof Circle) {
				
			}
			else {
				list3D.add(shapeSelect);
			}
		}
	}
