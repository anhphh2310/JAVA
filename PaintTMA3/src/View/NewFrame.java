			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (pos == 0) {
					if (textFieldX.getText().equals("") || textFieldY.getText().equals("")
						...
						s = ShapeFactory.getInstanceCircle(new ShapeFactory2d(Integer.parseInt(textWidth.getText()), -1, x, y));
						s= ShapeFactory.getInstanceCircle(new ShapeFactory2d(x, x, Integer.parseInt(textWidth.getText()), -1))
