...
public class MainFrame extends JFrame {
	...
	private static List<Shape> listRemove = new ArrayList<>();
	...
	public static void initShape() {
		listShape.add(ShapeFactory.getInstanceCircle(new ShapeFactory2d(20, 50, 20, -1)));
		listShape.add(ShapeFactory.getInstanceCircle(new ShapeFactory2d(50, 200, 100,-1)));

		listShape.add(ShapeFactory.getInstanceRectangle(new ShapeFactory2d(50, 20, 100, 200)));
		listShape.add(ShapeFactory.getInstanceRectangle(new ShapeFactory2d(60, 30, 200, 200)));
		listShape.add(ShapeFactory.getInstanceRectangle(new ShapeFactory2d(90, 60, 300, 200)));
